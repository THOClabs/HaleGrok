...
4. **Approve is the only publish action.** Draft for `@thenlaguna`. No auto-post.
   **Long 4K is a second handshake:** you run the sim; if we both like it, we
   commission the picture (12 min flagship = 48 × 15s clips). Nothing is
   generated until that click, and then we shoot together on later continues.
...
- [x] S1j — Ep 07–12 4K: Forty-Five, Iron Sinks, Roche, Hours, Five-Hour Terra, Luna
